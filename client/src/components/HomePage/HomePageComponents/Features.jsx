        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-14 text-center">
            ...
            <p className="text-lg font-normal text-gray-500 max-w-md md:max-w-2xl mx-auto">
              Explore Our Advanced Features: Seamless Translation, Versatile
              Downloads, Effortless History Tracking, and Personalized
              Bookmarking.
            </p>
          </div>
          <div className="flex justify-center items-center gap-x-5 gap-y-8 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8">
            <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
              ...
              <p className="text-sm font-normal text-gray-500">
                Experience seamless translation for text, images, PDFs, voice
                inputs, and even handwritten documents, all in one place.
                Achieve high accuracy and fast results with our robust
                translation engine.
              </p>
            </div>
            <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
              ...
              <p className="text-sm font-normal text-gray-500">
                Effortlessly download translations in various formats, including
                images, PDFs, and MP3 files. Save and share your work with ease,
                Convenient access to your translated content, anytime, anywhere.
              </p>
            </div>
            <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
              ...
              <p className="text-sm font-normal text-gray-500">
                Efficiently track all your past translations in one place.
                Access previous results quickly without re-entering the same
                content. Stay organized and save time with a comprehensive
                history feature.
              </p>
            </div>
            <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
              ...
              <p className="text-sm font-normal text-gray-500">
                Save your favorite translations for instant access whenever
                needed. Keep important translations handy and well-organized for
                easy retrieval. Simplify your workflow with personalized
                bookmark management.
              </p>
            </div>
          </div>
